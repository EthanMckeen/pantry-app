...
exports.WeaviateFunctionNames = exports.queryTypeToFunctionToProps = void 0;
/**
 ...
 */
exports.queryTypeToFunctionToProps = {
    graphql: {
...
exports.WeaviateFunctionNames = Object.entries(exports.queryTypeToFunctionToProps).map(([operationType, operations]) => {
    return Object.entries(operations).map(([operation, methods]) => {
